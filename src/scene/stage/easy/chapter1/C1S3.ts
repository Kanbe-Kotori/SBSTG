class C1S3 extends StageBase {
    ...
    protected initEmitters() {
        ...
        launcher2.addLogic(
            new AroundLauncher(launcher2, launcher1, 7500, 240).setTheta(0)
        )
        launcher2.addLogic(
            new Sniper(
                launcher2,
        ...
        launcher3.addLogic(
            new AroundLauncher(launcher3, launcher1, 7500, 240).setTheta(2/3 * Math.PI)
        )
        launcher3.addLogic(
            new Sniper(
                launcher3,
        ...
        launcher4.addLogic(
            new AroundLauncher(launcher4, launcher1, 7500, 240).setTheta(4/3 * Math.PI)
        )
        launcher4.addLogic(
            new Sniper(
                launcher4,
        ...
        launcher5.addLogic(
            new AroundLauncher(launcher5, launcher1, 7500, 240).setTheta(1/3 * Math.PI).setClockwise(false)
        )
        launcher5.addLogic(
            new Sniper(
                launcher5,
        ...
        launcher6.addLogic(
            new AroundLauncher(launcher6, launcher1, 7500, 240).setTheta(3/3 * Math.PI).setClockwise(false)
        )
        launcher6.addLogic(
            new Sniper(
                launcher6,
        ...
        launcher7.addLogic(
            new AroundLauncher(launcher7, launcher1, 7500, 240).setTheta(5/3 * Math.PI).setClockwise(false)
        )
        launcher7.addLogic(
            new Sniper(
                launcher7,
