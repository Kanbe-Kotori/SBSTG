class Stage1_3 extends StageBase {
    ...
    protected onAddToStage(event:egret.Event) {
        ...
        let up1_2 = new RegularMissileUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setTexture(TextureNames.MISSILE_WATER));
        ...
        up2_1.setFreq(50);
        let up2_2 = new SniperUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setVelocity(13));
        ...
        up3_1.setFreq(50);
        let up3_2 = new SniperUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setVelocity(13));
        ...
        up4_1.setFreq(50);
        let up4_2 = new SniperUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setVelocity(13));
        ...
        up5_1.setFreq(50);
        let up5_2 = new SniperUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setVelocity(13));
        ...
        up6_1.setFreq(50);
        let up6_2 = new SniperUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setVelocity(13));
        ...
        up7_1.setFreq(50);
        let up7_2 = new SniperUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setVelocity(13));
