class Stage1_4 extends StageBase {
    ...
    protected initEmitters() {
        ...
        let point1 = new egret.Point(540, 660);
        ...
        let up1_2 = new RegularMissileUpgrade(
            new MissileConfig(MissileUtils.MISSILE_ELLIPTICAL)
				...
				.setVelocity(12)
				.addHandler(handler1.clone().setStartTicks(20))
		...
		let point2 = new egret.Point(360, 660);
        ...
        let up2_2 = new RegularMissileUpgrade(
            new MissileConfig(MissileUtils.MISSILE_ELLIPTICAL)
				...
				.addHandler(handler2.clone().setStartTicks(15))
            )
		...
		let point3 = new egret.Point(720, 660);
		...
		let point4 = new egret.Point(540, 480);
        ...
        .setEndAngle(1)
        .setNumber(2);
		let up4_3 = new EmitterRotateUpgrade().setParentEmitter(up4_2).setRad(2 / 4 / 20);
	}
}