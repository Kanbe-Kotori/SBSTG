class Stage1_2 extends StageBase {
    ...
    protected onAddToStage(event:egret.Event) {
        ...
        up2_1.setFreq(50);
        let up2_2 = new SniperUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setVelocity(17));
        ...
        up3_1.setFreq(50);
        let up3_2 = new SniperUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setVelocity(17));
        ...
        up4_1.setFreq(50);
        let up4_2 = new SniperUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setVelocity(17));
        ...
        up5_1.setFreq(50);
        let up5_2 = new SniperUpgrade(new MissileConfig(MissileUtils.MISSILE_STANDARD).setVelocity(17));
