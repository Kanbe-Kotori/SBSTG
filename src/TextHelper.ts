class TextHelper {
	...
	public static init() {
		...
		new StageInfo(
			"2-1",
			"细雨",
			"本章节的所有关卡均包含上方随机弹。请时刻留心四周（而不仅仅是上方），防止被子弹封位。\n\n" + 
			"友情提示：在版底躲避弹幕很危险，因为随时都有可能被封位，而在屏幕中心区域左右移动并上穿会容易的多。"
		);
		new StageInfo("2-2", "大雨", "还没写");
		new StageInfo("2-3", "狂风", "还没写");
		new StageInfo("2-4", "旋涡", "还没写");
		new StageInfo(
			"2-5",
			"冰雹",
			"本关也是制作组黔驴技穷凑出的一关，不仅没什么亮点还有点瞎。"
		);
		new StageInfo(
			"2-ex",
			"天火",
			"虽然火雨看起来很吓人，其实瑟缩在版底小心不要被封位就好了，难度并没有像看起来那么高。\n\n" +
