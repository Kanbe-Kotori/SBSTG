class TextHelper {
	...
	public static initStageText() {
		...
		+ "\n\n本关设计者：chitose";
		StageData.stage2_5.help_text = "本关的解法正如标题所说，在板底左右横跳就可以了。"
		+ "\n\n本关制作者：chitose"
		+ "\n\n本关设计者：忘了哪里看到的自制LuaSTG关卡";
		StageData.stage2_6.help_text = "还没写。"
		+ "\n\n本关设计者：chitose";
		StageData.stage2_7.help_text = "还没写。"
		+ "\n\n本关设计者：chitose";
		...
		+ "\n\n本关设计者：chitose";
		StageData.stage3_2.help_text = "还没写。"
		+ "\n\n本关设计者：chitose";
		StageData.stage3_3.help_text = "还没写。"
		+ "\n\n本关制作者：chitose"
		+ "\n\n本关设计者：花花";
		StageData.stage3_4.help_text = "还没写。"
		+ "\n\n本关设计者：chitose";
		StageData.stage3_5.help_text = "还没写。"
		+ "\n\n本关设计者：chitose"
		+ "\n\n本关设计者：忘了哪里看到的自制LuaSTG关卡";
		StageData.stage3_6.help_text = "还没写。"
		+ "\n\n本关设计者：chitose";
		StageData.stage3_7.help_text = "虽然火雨看起来很吓人，其实瑟缩在版底注意不要被封位就好了，难度并没有像看起来那么高。不过毕竟是EX关卡，再怎么也不会完全白给。"
