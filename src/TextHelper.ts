class TextHelper {
	...
	public static initStageText() {
		...
		StageData.stage1_1.help_text = "本关乍一看虽然非常恐怖，但如果你认真看过教程关的小贴士，本关就是完全白给。";
		StageData.stage1_2.help_text = "本关和1-1解法类似，但在微移躲自机狙（莲子）时，也要注意把握好穿过慢速花瓣固定弹的时机。\n\n" + 
			"由于莲子弹是逐渐减速的，因此在屏幕下方进行规避会稍微简单一些。"
		StageData.stage1_3.help_text = "本关包括紫色固定弹，粉色自机狙和蓝色白给弹，注意微移躲自机狙的时候不要被固定弹击中。";
